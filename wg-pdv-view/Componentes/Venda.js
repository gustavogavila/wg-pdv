...
console.log(condicao)
       if(condicao){
       let produtoSelecionado = tProdutos.Buscar('id',VALOR('#produtoSelecionado'))[0];
  ...
  cliente(){
   ...
   update(){
    this.dados.venda.total = this.dados.venda.produtos.reduce((acc,cur)=>acc+=(cur.Valor*cur.Quantidade),0)
    app.montarView(); 
   }
